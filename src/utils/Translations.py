PTBR_STATS_LIST = ['HP', 'Ataque', 'Defesa', 'Ataque Especial', 'Defesa Especial', 'Velocidade']
PTBR_TYPES = {'grass': 'Grama', 'water': 'Água', 'fire': 'Fogo',
              'normal': 'Normal', 'electric': 'Elétrico', 'ice': 'Gelo',
